...
**Code revision:** [dc7df5b](https://github.com/tezos-commons/homebase-lite/commit/dc7df5ba8bf3f793b6ebed5283e37db060b89714) *(Wed Feb 2 23:41:00 2022 +0300)*
...
**Final Michelson representation:** `pair (pair address address (big_map address unit)) (pair (pair nat nat) nat nat) (big_map string (pair (pair nat timestamp) timestamp nat (list string))) (big_map (pair string address) nat)`
