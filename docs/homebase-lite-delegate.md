...
**Code revision:** [014962b](https://github.com/tezos-commons/homebase-lite/commit/014962b06302bfb1ee53ff83d8b5a36b0d428e97) *(Fri Mar 4 15:33:47 2022 +0100)*
...
1. Call contract's `admin` entrypoint passing the constructed argument.
</details>
<p>
...
0. Construct an argument for the entrypoint.
1. Call contract's `voting` entrypoint passing the constructed argument.
</details>
<p>
